...
xhr.open(
  "GET",
  "https://raw.githubusercontent.com/LuizASSilveira/pi-almoxarifado/master/teste.json"
); //tipo de requisição + end.
...
function montaTr(solicitacao) {
  ...
  solicitacaoTr.appendChild(
    montaTd(solicitacao.solicitante, "info-solicitante")
  );
